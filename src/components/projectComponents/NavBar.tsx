...
export default function NavBar() {
  ...
  return (
    <header>
      <div className={'flex justify-between p-1 max-w-screen-xl m-auto '}>
        {/* LOGO*/}
        <div className={'flex flex-row items-center gap-2 cursor-pointer w-20'}>
          <NavLink to={'/'}>
            {theme === 'dark' ? <img src={'logo3D.png'} className={''} /> : <img src={'logo3.png'} className={''} />}
          </NavLink>
        </div>
        ...
        <ul className={'flex gap-2 items-center'}>
          <li className={''}>
            <a target='_blank' rel='noreferrer' href='https://github.com/prjwl16'>
              <div className='inline-flex items-center justify-center rounded-md text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-9 py-2 w-9 px-0'>
                <svg viewBox='0 0 438.549 438.549' className='h-6 w-4'>
                  <path
                    fill='currentColor'
          ...
          <li>
            <a target='_blank' rel='noreferrer' href='https://twitter.com/prjwl_16'>
